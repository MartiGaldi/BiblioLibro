              ...
              <form method="post" action="iscrizione" enctype="multipart/form-data">
                ...
                <div class="form-check form-check-inline">
                  <label class="form-check-label">
                    <input class="form-check-input" type="radio" value="cliente" name="tipo" > Cliente </label>
                </div>
                <div class="form-check form-check-inline">
                  <label class="form-check-label">
                    <input class="form-check-input" type="radio" value="bibliotecario" name="tipo" checked> Bibliotecario </label>
                </div>
                <br>
                <br>
